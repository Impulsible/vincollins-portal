...
// src/app/student/classmates/page.tsx
'use client'
    ...
    const fetchProfile = async () => {
      try {
        ...
        const { data: profileData } = await supabase
          .from('profiles')
          .select('id, first_name, last_name, full_name, display_name, email, class, photo_url')
          .eq('id', user.id)
          .single()
          ...
          <div className="container mx-auto px-3 sm:px-4 lg:px-6 py-4 sm:py-6 max-w-6xl">
            ...
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-sm text-slate-500 mt-1">
                  View all students in {profile?.class}
                </p>
              </div>
            ...
            <StudentClassRoster 
              ...
              onClassmateClick={(classmate) => {
                console.log('Selected classmate:', classmate.display_name || classmate.full_name)
              }}
            />
