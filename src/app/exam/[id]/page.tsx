...
// Helper function to shuffle array - defined BEFORE it's used
...
export default function ExamPage() {
  ...
  // Handle auto-submit function - defined BEFORE useEffect that uses it
  ...
  }, [isSubmitting, questions, answers, examId, router])
  ...
  // Timer logic - depends on handleAutoSubmit
  useEffect(() => {
  ...
  }, [timeLeft, isPaused, handleAutoSubmit])
  ...
  // Tab switch detection - depends on handleAutoSubmit
  useEffect(() => {
  ...
  }, [isPaused, timeLeft, isSubmitting, handleAutoSubmit])
