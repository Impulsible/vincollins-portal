// app/staff/announcements/page.tsx - FIXED
'use client'
...
export default function StaffAnnouncementsPage() {
  ...
  const headerUser: HeaderUser | undefined = useMemo(() => {
    if (contextUser) {
      return {
        id: contextUser.id,
        name: contextUser.full_name || contextUser.first_name || 'Staff',
        firstName: contextUser.first_name || contextUser.full_name?.split(' ')[0] || 'Staff',
    ...
    return cachedHeaderUser ? { ...cachedHeaderUser, role: 'teacher' as const } : undefined
  }, [contextUser])
  ...
  const userRole = contextUser.role?.toLowerCase()
  if (userRole !== 'staff' && userRole !== 'teacher' && userRole !== 'admin') return null
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100">
      ...
      <div className="flex">
        {/* Sidebar - Now includes required props */}
        <StaffSidebar 
          ...
          <main className="pt-[72px] lg:pt-24 pb-8 sm:pb-12">
            <div className="px-4 sm:px-6 lg:px-8">
              <div className="max-w-6xl mx-auto">
                ...
                {/* Announcements Component - Hide internal header */}
