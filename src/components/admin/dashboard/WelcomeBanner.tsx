    ...
    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#06152f] via-[#0b2a5b] to-[#17479e] p-8 shadow-2xl ring-1 ring-white/10">
      ...
      <div className="relative z-10 flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex flex-col gap-3 md:items-end">
          ...
          <div className="flex flex-wrap gap-3">
            <div className="flex items-center gap-2 rounded-xl border border-cyan-300/20 bg-white/10 px-3 py-2">
            ...
            <div className="flex items-center gap-2 rounded-xl border border-emerald-300/20 bg-white/10 px-3 py-2">
          ...
          <div className="flex flex-wrap gap-3">
            <div className="flex items-center gap-2 rounded-xl border border-sky-300/20 bg-white/10 px-3 py-2">
            ...
            <div className="flex items-center gap-2 rounded-xl border border-violet-300/20 bg-white/10 px-3 py-2">
