      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between flex-wrap gap-4">
          <div>
            ...
            <CardDescription>{questions.length} questions • {totalPoints} total points</CardDescription>
          </div>
                    ...
                    <div key={q.id} className="p-4 bg-slate-50 dark:bg-slate-900 rounded-xl group">
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <p className="font-medium">{startIndex + idx + 1}. {q.question_text}</p>
                          {q.options && (
                        ...
                        <div className="flex gap-1 ml-4">
                          ...
                          <Button variant="ghost" size="sm" onClick={() => onDeleteQuestion(q.id)} className="h-8 w-8 p-0 text-red-500">
