...
// ✅ FIXED: Import from app/student/types (not @/types/student)
import { 
  StudentProfile, 
  PerformanceStats, 
  BannerStats, 
...
// ✅ FIXED: Import from app/student/utils (not @/utils/student)
